...
def get_pose_pkl(inf):
    ...
    for pose_R_id in pose_R:
        ...
        # pose_E_id = rotationMatrixToEulerAngles(pose_R_id)
    ...
    # global_rot_E = rotationMatrixToEulerAngles(global_rot_R)
...
if __name__ == '__main__':
    ...
    for pkl_file in pkl_files:
        t0 = time.time()
        # 读取pkl文件
        pkl_inf = pkl_read(os.path.join(pkl_folder_name, pkl_file))
