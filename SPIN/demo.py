...
def process_image(img_file, bbox_file, openpose_file, input_res=224):
    ...
    """
    normalize_img = Normalize(mean=constants.IMG_NORM_MEAN, std=constants.IMG_NORM_STD)  # 图像归一化
    ...
    img = torch.from_numpy(img).permute(2, 0, 1)  # 维度换位
...
if __name__ == '__main__':
    ...
    model.eval()  # 不启用 Batch Normalization 和 Dropout.参考链接：https://blog.csdn.net/qq_38410428/article/details/101102075
